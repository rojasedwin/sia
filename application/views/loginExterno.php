...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Crestanevada - Felicidad de Serie" />
...
<div class="container">
            ...
            <div class="col-lg-4 col-sm-6 col-xs-10 col-lg-offset-4 col-sm-offset-3 col-xs-offset-1">
                <h4 style='color:#fff;' class="widget-login-logo animated fadeInUp">
                    <i class="fa fa-circle text-gray"></i>
                     <?php echo "Proveedores Externos";?>
                    <i class="fa fa-circle text-warning"></i>
                </h4>
                <section style='background-color:#fff;color:#ff0000;' class="widget widget-login animated fadeInUp">
                    <header style='text-align: center;' >
                      <img style='max-height:100px;max-width:100%;margin:auto;margin-top:-5px;' src='<?php echo base_url();?>attachments/web/logo_2.jpg?1.2'>
                    </header>
                ...
                <form class="login-form mt-lg" id="admin" action='<?php echo base_url();?>auth/authenticateExterno' method='POST'>
                  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    ...
                    <div class="form-group">
                      <label>  <input class="" value='1' id="rememberme" name='rememberme' type="checkbox" placeholder="Remember me">
                        Recordarme.</label>
                    </div>
                    <div class="clearfix">
                            <input type="submit" class="btn btn-info btn-block"  value="Entrar" name='Entrar'>
                    </div>
    ...
    <footer class="page-footer">
        <?php echo date("Y");?> &copy; Crestanevada
    </footer>
</div>
