          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
				 <button type="button" onclick="fichaItem()" class="prueba btn btn-block bg-gradient-primary btn-sm">+ Nuevo Usuario</button>
				</h3>
              </div>
              <!-- /.card-header -->
              <div id="resultados_usuarios" class="card-body table-responsive-md">
