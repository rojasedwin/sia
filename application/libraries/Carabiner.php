...
class Carabiner {
	...
	*/
	public function __construct()
	{
		...
		//if( $this->CI->config->load('carabiner', TRUE, TRUE) ){
			...
			$carabiner_config = array();
			$carabiner_config['script_dir'] = $this->CI->config->item('carabiner_script_dir');
			$carabiner_config['style_dir'] = $this->CI->config->item('carabiner_style_dir');
			$carabiner_config['cache_dir'] = $this->CI->config->item('carabiner_cache_dir');
			$carabiner_config['dev'] = $this->CI->config->item('carabiner_dev');
			$carabiner_config['combine'] = $this->CI->config->item('carabiner_combine');
			$carabiner_config['minify_js'] = $this->CI->config->item('carabiner_minify_js');
			$carabiner_config['minify_css'] = $this->CI->config->item('carabiner_minify_css');
			$carabiner_config['force_curl'] = $this->CI->config->item('carabiner_force_curl');
	...
	*/	
	...
	{	
		...
		log_message('debug', 'Carabiner: CACHE PATH >>.'.$this->cache_path);
	}
