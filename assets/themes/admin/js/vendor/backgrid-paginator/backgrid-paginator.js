...
(function (root, factory) {
  ...
  if (typeof exports == "object") {
    module.exports = factory(require("underscore"),
                             require("backbone"),
                             require("backgrid"),
                             require("backbone.pagetor"));
  }
  // AMD. Register as an anonymous module.
  else if (typeof define === 'function' && define.amd) {
    define(['underscore', 'backbone', 'backgrid', 'backbone.pagetor'], factory);
  }
  // Browser
  else {
  ...
  /**
     ...
     click events and triggers pagetion.
  ...
  */
  var Paginator = Backgrid.Extension.Paginator = Backbone.View.extend({
    ...
    */
    ...
    /**
       Render the pagetor handles inside an unordered list.
    */
    render: function () {
      this.$el.empty();
