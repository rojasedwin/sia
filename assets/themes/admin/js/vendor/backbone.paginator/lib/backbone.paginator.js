...
(function (factory) {
  ...
  */
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    /**
       The container object to store all pagetion states.
    ...
    */
    ...
    /**
       ...
       operations for this collection. `"server"` pagetes on the server-side,
       `"client"` pagetes on the client-side and `"infinite"` pagetes on the
    ...
    */
    ...
    /**
       Sanity check this collection's pagetion states. Only perform checks
    ...
    */
    ...
    /**
       Parse pagetion links from the server response. Only valid under
       infinite mode.

       Given a response body and a XMLHttpRequest object, extract pagetion
    ...
    */
    ...
    /**
       ...
       The first structure is the preferred form because the pagetion states
    ...
    */
    ...
    /**
       Parse server response for server pagetion state updates. Not applicable
       under infinite mode.
       ...
       `totalRecords` value is enough to trigger a full pagetion state
       recalculation.
    ...
    /**
       ...
       The query string is constructed by translating the current pagetion
